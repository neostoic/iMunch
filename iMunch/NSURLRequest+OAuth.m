...
static NSString * const kConsumerKey       = @"VJleKneFYLjw2ODf3A9sGg";
static NSString * const kConsumerSecret    = @"tx24SEaKFhwcucfciIaUQuxq8os";
static NSString * const kToken             = @"ZlCIZwoWifQc0OLFR1iJMQdfj-C03IBo";
static NSString * const kTokenSecret       = @"UAr36fUNRCtK-SKPQVfAUuA4owk";
